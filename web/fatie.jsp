		...
		<div class="layui-container fly-marginTop">
			<div class="fly-panel" pad20="" style="padding-top: 5px;">
				<div class="layui-tab layui-tab-brief" lay-filter="user">
					...
					<form id="form" action="${pageContext.request.contextPath }/cart/newCart.html" method="post">
					<!-- 富文本编辑器内容 -->
					 ...
					 <input type="hidden" name="userId" value="${sessionScope.user.id }" />
						<div class="layui-form layui-form-pane" style="padding: 20px 0;">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input id="L_title" type="text" name="title" required lay-verify="required" autocomplete="off" class="layui-input">
								</div>
							</div>
