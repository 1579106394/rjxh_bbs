    ...
    <div class="fly-panel fly-panel-user" pad20="">
        ...
        <div class="layui-tab layui-tab-brief" lay-filter="user">
            <ul class="layui-tab-title" id="LAY_mine">
                ...
                <li lay-id="collection">我收藏的帖（
                    <span id="myShoucangNum">0</span>）
                </li>
                <li><a href="${pageContext.request.contextPath }/fatie.html">发表新帖</a></li>
            </ul>
...
<script type="text/javascript">
            ...
            success: function (data) {
                ...
                for (var i = 0; i < cartList.length; i++) {
                    ...
                    $("#myCartTbody").append(
                        ...
                        "  <button class='layui-btn layui-btn-xs'onclick='editCart(" + cartList[i].cartId + ")'>编辑</button>    " +
                        "</div>                                       " +
    ...
    function deleteCart(id) {
        layer.confirm('确定要删除吗?', {icon: 3, title: '提示'}, function (index) {
            //do something
            window.location.href = "${pageContext.request.contextPath}/user/delete" + id + ".html";
            layer.close(index);
        });
    }
    ...
    function editCart(id) {
        window.location.href = "${pageContext.request.contextPath}/cart/toEdit" + id + ".html";
    }
            ...
            success: function (data) {
                ...
                for (var i = 0; i < cartList.length; i++) {
                    ...
                    $("#myShoucangTbody").append(
                        ...
                        "		<div class='layui-table-cell laytable-cell-1-4'><span>" +
                        "<div class='layui-btn-group'>                " +
                        "  <button class='layui-btn layui-btn-xs'onclick='deleteShoucang(" + cartList[i].cartId + ", ${sessionScope.user.id})'>取消收藏</button>    " +
                        "</div>                                       " +
    ...
    /* 取消收藏 */
    function deleteShoucang(id, userId) {
        layer.confirm('确定要取消收藏吗?', {icon: 3, title: '提示'}, function (index) {
            //do something
            window.location.href = "${pageContext.request.contextPath}/user" + userId + "/deleteShoucang" + id + ".html";
            layer.close(index);
        });
    }
