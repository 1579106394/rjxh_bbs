...
<html>
	...
	<head>
		...
		<title>用户登录 - 井冈山大学软件协会 - 致力于打造井大最强IT协会！</title>

		<meta name="keywords" content="软件协会,井冈山大学,井冈山大学软件协会,软件实验室,软件创新实验室,北斗之芯,北斗之芯实验室,北斗之芯协会,电脑爱好者协会,网络协会,北斗之芯实验室,网络实验室">
		<meta name="description" content="井冈山大学软件协会 - 致力于打造井大最强IT协会！">
			...
			<div class="fly-panel fly-panel-user" pad20="">
				<div class="layui-tab layui-tab-brief">
					<ul class="layui-tab-title">
						...
						<li class="layui-this">评论我的（
							<span id="myHuifuNum">0</span>）</li>
					</ul>
											...
											<thead>
												<tr>
													...
													<th data-field="status">
														<div class="layui-table-cell laytable-cell-1-status"><span>回复内容</span></div>
													</th>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/home.js"></script>
		...
		$(function() {
			...
			var value="{\"id\":\""+id+"\"}";
			$.ajax({
				url : "${pageContext.request.contextPath}/user/getMyHuifuList.action",
				data : value,
				...
				success : function(data){
						...
						for(var i=0;i<commonList.length;i++){
							...
							$("#myHuifuTbody").append(
								...
								"<a href='${pageContext.request.contextPath}/cart/"+commonList[i].cart.cartId+".html'>"+commonList[i].cart.title+"</a>"+
								"</span></div>               "+
								"	</td>                                                                                             "+
								"	<td >                                                                                             "+
								"		<div class='layui-table-cell laytable-cell-1-status'><span>"+commonList[i].comment.article+"</span></div>   "+
								"	</td>                                                                                             "+
								"	<td >                                                                                            "+
								"		<div class='layui-table-cell laytable-cell-1-4'><span>"+
								"<div class='layui-btn-group'>                " +
								"  <button class='layui-btn layui-btn-xs'onclick='deleteHuifu("+commonList[i].comment.cId+")'>删除回复</button>    " +
								"</div>                                       "+
		...
		function deleteHuifu(id) {
			layer.confirm('确定要删除吗?', {icon: 3, title:'提示'}, function(index){
			  //do something
			  window.location.href = "${pageContext.request.contextPath}/user/deleteHuifu"+id+".html";
			  layer.close(index);
			});
		}
		</script>
