			...
			<div class="fly-panel" pad20="" style="padding-top: 5px;">
				<div class="layui-tab layui-tab-brief" lay-filter="user">
					<ul class="layui-tab-title">
						<li class="layui-this">编辑模块</li>

					</ul>
					<form id="form" action="${pageContext.request.contextPath }/type/editType.html" method="post">
						<div class="layui-form layui-form-pane" style="padding: 20px 0;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input id="L_title" type="text" name="name" value="${type.name}" required lay-verify="required" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input id="L_title" type="text" name="url" value="${type.url}" required lay-verify="required" autocomplete="off" class="layui-input">
                                </div>
                            </div>
							...
							<div class="layui-form-item">
								<button class="layui-btn" type="submit">立即修改</button>
							</div>
