			...
			<div class="fly-panel" pad20="" style="padding-top: 5px;">
				<div class="layui-tab layui-tab-brief" lay-filter="user">
					<ul class="layui-tab-title">
						<li class="layui-this">发表通知</li>

					</ul>
					<form id="form" action="${pageContext.request.contextPath }/notice/newNotice.html" method="post">
					<!-- 富文本编辑器内容 -->
						...
						<div class="layui-form layui-form-pane" style="padding: 20px 0;">
							...
							<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<select id="select1" class="select1" name="userId">
	                                    </select>
									</div>
							</div>
						    ...
						    <script type="text/javascript" src="${pageContext.request.contextPath }/editor/dist/js/wangEditor.js"></script>
						    <script type="text/javascript">
						        $(function () {
							...
							<div class="layui-form-item">
								<button class="layui-btn" onclick="formSubmit();">立即发布</button>
							</div>
		...
		function typeList() {
			$.ajax({
				...
				success : function(dep){
						...
						$(".select1").append("<option selected='selected' value='0'>全部用户</option>");
						for(var i = 1; i < cartList.length; i++) {
							$(".select1").append("<option id='" + cartList[i].id + "' value='" + cartList[i].id + "'>" + cartList[i].niko  + "</option>");
						}
